...
export default function RegisterForm() {
    const { register, control, handleSubmit, setValue, setError, reset, formState: { isValid, errors } } = useForm({
        mode: "all",
        ...
        try {
            ...
            if (user) {
                setError(
                    ...
                    {
                        type: "custom",
                        message: "Bu Emaille Bir Kayıt Oluşturulmuş"
                    })
                setLoading(false)
                return
            }
            ...
            console.log("User Registiration-Error")
            console.log(error)
            setLoading(false)
        }
